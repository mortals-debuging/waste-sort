...
from EfficientNet import efficientnet_b4 as create_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="./waste-pic")
    parser.add_argument('--weights', type=str, default='./trained_weights/efficientnetb4.pth',
